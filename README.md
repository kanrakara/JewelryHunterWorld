...
### 作品について
Unityで2Dゲームを学ぶに当たって、基本的な機能が網羅されている作品となるように作成しました。アクションゲームとしての楽しさが出るようにたくさんのギミックをちりばめています。  
書籍『たのしい2Dゲームの作り方』をベースにしつつ、独自のセーブシステムやボス戦ロジックを組み込み、ひとつのパッケージとして完結させました。
